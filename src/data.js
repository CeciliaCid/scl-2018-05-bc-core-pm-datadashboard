...
function sortUsers(users, orderby, orderDirection) {
  if (orderDirection === 'ASC') {
    ...
    if (orderby === 'Total')
      users.sort((aaa, bbb) => aaa.stats.percent - bbb.stats.percent);
    if (orderby === 'Lecturas')
      users.sort((aaa, bbb) => aaa.stats.reads.percent - bbb.stats.reads.percent);
    if (orderby === 'Ejecicios')
      users.sort((aaa, bbb) => aaa.stats.exercises.percent - bbb.stats.exercises.percent);
    if (orderby === 'Cuestionarios')
      users.sort((aaa, bbb) => aaa.stats.quizzes.percent - bbb.stats.quizzes.percent);
    if (orderby === 'Suma cuestionarios')
      users.sort((aaa, bbb) => aaa.stats.quizzes.scoreSum - bbb.stats.quizzes.scoreSum);
  } else {
    if (orderby === 'Nombre')
      users.sort((aaa, bbb) => bbb.name.localeCompare(aaa.name));
    if (orderby === 'Total')
      users.sort((aaa, bbb) => bbb.stats.percent - aaa.stats.percent);
    if (orderby === 'Lecturas')
      users.sort((aaa, bbb) => bbb.stats.reads.percent - aaa.stats.reads.percent);
    if (orderby === 'Ejecicios')
      users.sort((aaa, bbb) => bbb.stats.exercises.percent - aaa.stats.exercises.percent);
    if (orderby === 'Cuestionarios')
      users.sort((aaa, bbb) => bbb.stats.quizzes.percent - aaa.stats.quizzes.percent);
    if (orderby === 'Suma cuestionarios')
      users.sort((aaa, bbb) => bbb.stats.quizzes.scoreSum - aaa.stats.quizzes.scoreSum);
  }
  return users;
}
